...
export const profiles: Record<"mark" | "sam", Profile> = {
  mark: {
    ...
    experience: [
      { role: "Founder, President & Realtor-Broker", org: "True Real Estate Hawaiʻi, LLC", dates: "2017 – Present", detail: "Founded the independent Hawaiʻi brokerage at 33 and leads client work across residential, investment, and development decisions on Oʻahu, according to the company record and Pacific Business News.", mark: "TR" },
